...
import { ShyftStakeModal, $Card } from './'
...
export const ShyftStake = (): React.ReactElement => {
  ...
  return (
    <>
      ...
      {showModal && <ShyftStakeModal isOpen={showModal} onClose={toggleModal} onSuccess={onStakeSuccess} />}
    </>
  )
}
